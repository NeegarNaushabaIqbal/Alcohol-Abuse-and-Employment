...
```{r}
lpm_extended_2 <- lm(employ ~ abuse + age + agesq + educ + educsq + married + famsize +
...
```{r}
probit_extended_2 <- glm(employ ~ abuse + age + agesq + educ + educsq + married + famsize +
                         white + unemrate + exhealth + vghealth + goodhealth + fairhealth,
                       family = binomial(link = "probit"),
                       data = alcohol)
...
```{r}
first_stage_2 <- lm(abuse ~ mothalc + fathalc + age + agesq + educ + educsq + married +
                    famsize + white + unemrate + exhealth + 
    vghealth + goodhealth + fairhealth, data = alcohol)
